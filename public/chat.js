...
const normalizerDataContainer = document.getElementById('normalizerData');
...
socket.on('normalizerData', data => {
    console.log('originalData', data);
    normalizerDataContainer.innerHTML += `<p>Porcentaje de compresion: ${data}</p>`
})
